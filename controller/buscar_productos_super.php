...
$nombre_db = "productos_base"; //Nombre de la tabla de productos del usuario que hace la petición.
...
foreach($busqueda->buscar($termino, $rubro, $empezar, $entradas) as $registro){
    ...
    echo "<td>"; 
    echo "<button style='margin-top:10px !important; margin-left:30px !important;' onClick='eliminar(".$registro["Codigo"].")'class='btn btn-default btn-sm'><i class='fas fa-trash' style='color:dark-red'></i></button>";
    echo "</td>";    
    echo "</tr>";
}
//----------------------------------------------------------------------//
