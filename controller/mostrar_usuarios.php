...
//------------------------//
$mostrar = new Usuario(); // Este objeto es el que tiene los diferentes métodos para mostrar la tabla de usuarios al cargar el documento.
...
$bloqueados = $_GET["bloqueados"];// estado de usuarios a mostrar.
...
//----------------------------------------------------------------------//
foreach($mostrar->mostrar($ordenar, $empezar, $entradas, $isActivo) as $registro){
