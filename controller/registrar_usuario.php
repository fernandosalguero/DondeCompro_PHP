...
if (!$usuario->consultar($nombre)) {
    ...
    if ($conexion->insertar_temp($nombre, $correo, $clave_cifrada, $perfil, $estado, $fecha, $activacion_con, $provincia, $municipio, '', $localidad, $latitud, $longitud)) {
    ...
    header("location: ../view/registrar-usuario.php");
}
